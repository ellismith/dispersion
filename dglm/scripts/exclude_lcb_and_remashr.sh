...
CT=$1
MC=$2
SRC=/scratch/easmit31/dispersion/dglm/disp_age__mincells${MC}_300c/${CT}/dglm_checkpoints_cutoff0.5
DEST=/scratch/easmit31/dispersion/dglm/disp_age__mincells${MC}_300c_noLcb_QCfiltered/${CT}/dglm_checkpoints_cutoff0.5
mkdir -p $DEST
...
cat('$CT mc$MC (noLcb+QC): flagged', n_flagged_total, '\n')
"
