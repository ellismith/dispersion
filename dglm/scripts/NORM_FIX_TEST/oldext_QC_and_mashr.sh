...
DEST=/scratch/easmit31/dispersion/dglm/disp_age__FIXEDDISP2_300c_QCfiltered/${CT}/dglm_checkpoints_cutoff0.5
mkdir -p $DEST
...
cat('$CT (old ext, QC) flagged:', n_flagged_total, '\n')
"
